...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('notification_type', models.CharField(choices=[('like_post', 'Like Post'), ('like_comment', 'Like Comment'), ('comment', 'Comment'), ('reply', 'Reply'), ('mention', 'Mention'), ('collect', 'Collect'), ('follow', 'Follow'), ('message', 'Message')], max_length=50)),
        ...
        migrations.AddConstraint(
            model_name='notifications',
            constraint=models.UniqueConstraint(deferrable=django.db.models.constraints.Deferrable['DEFERRED'], fields=('recipient', 'sender', 'post', 'comment', 'message', 'notification_type', 'created_at'), name='unique_notification_constraint'),
        ),
        migrations.AddIndex(
            model_name='comments',
